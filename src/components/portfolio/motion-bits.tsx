...
export function MagneticButton({ children, className = "", onClick, href, as = "button" }: {
  ...
  const Tag: any = as;
  return (
    <Tag ref={ref} href={href} onClick={onClick} className={`transition-transform duration-200 ease-out will-change-transform ${className}`}>
      {children}
    </Tag>
  );
}
